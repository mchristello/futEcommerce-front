    ...
    return (
        <section className="px-6 py-12 lg:px-8 rounded-xl backdrop-blur-sm bg-white/40 mt-10">
            ...
            <form className="flex flex-col gap-5 text-xl mt-10" onSubmit={handleSubmit(onSubmit)}>
                ...
                <input {...register("password", { required: true })} className="px-1.5 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />

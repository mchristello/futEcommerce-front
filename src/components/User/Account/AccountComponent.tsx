                    ...
                    <div className="w-[80vw]">
                        <div className="flex flex-row text-center">
                            ...
                            <div className="flex flex-col justify-between p-4 leading-normal w-full m-3">
                                <div>
                                    <h3 className="text-3xl mb-4 font-bold tracking-tight text-gray-900 dark:text-white underline" >Welcome, {userData.first_name} !</h3>
                                    { userData.rol === 'admin'  
                                    ...
                                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-900" >E-mail: <i>{userData.email}</i></p>
                                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-900" >Name: <i>{userData.first_name}</i></p>

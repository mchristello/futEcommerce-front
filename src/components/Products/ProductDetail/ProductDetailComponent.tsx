        ...
        <section>
            <div className="w-full max-w-3xl bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="px-5 pb-5">
                    ...
                    <Link href="#">
                        <h4 className="text-xl font-medium tracking-tight text-gray-400 dark:text-white">{title}</h4>
                        <h4 className="text-xl font-medium tracking-tight text-gray-400 dark:text-white">{category}</h4>
                    </Link>
